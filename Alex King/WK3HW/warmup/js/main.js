...
// let text = $("#words").text().split(" ")
// // .replace(/\s+/g, '');

// // let uniqueWord = $.unique(text.match(/\w+/mg));
// randomWord = [];


// $("#wordGive").on("click", function(){
//     console.log(text.length)
//     // console.log(text.indexOf("us"))
//     for(var i=0; i<5; i++) { // showing 5 letters
//         let rn = Math.floor(Math.random() * text.length);
//         randomWord.push( text[rn]+ " ");
//         // uniqueWord.splice(rn, 1);
//     }
// console.log(randomWord)
// randomWord.toString(" ")
// $("body").append(randomWord)
// randomWord.splice()
// })
...
// //1. get contents of div as string and split
...
//             //a. get each word from array and place in new div
