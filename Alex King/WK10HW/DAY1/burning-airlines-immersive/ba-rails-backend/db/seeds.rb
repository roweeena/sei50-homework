...
r3 = Reservation.create! flight: f2, user: u3, row: 15, col: 4
...
# puts 
"Airplane #1 has #{Airplane.first.flights.length} flights (should be 2)"
...
puts "Reservation #1 has username #{Reservation.first.user.name} (should be 'Test User 1)"
