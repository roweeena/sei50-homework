...
arrayRandomElement: function(array){
...
generateInsult: function(){
    ...
    const firstAdjectiveRandomIndex = this.arrayRandomElement(this.firstAdjectives);
    const secondAdjectiveRandomIndex = this.arrayRandomElement(this.secondAdjectives);
    const nounsRandomIndex = this.arrayRandomElement(this.nouns);
