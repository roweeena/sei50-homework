...
//   let count = 0 //store how many times it takes for the num to reach 1
//
//   while ( num > 1 ){
//     if ( num % 2 === 0 ) {
//       num = num / 2
...
//   }
//   return `the final count is ${count}`
// }
//
...
const collatz_rec = function(num, count=0){
  ...
  //
  // if (num % 2 === 0){
  //   return collatz_rec(num / 2, count + 1)
  // }else {
  //   return collatz_rec((num * 3) + 1, count + 1)
  // }

  // one liner - only if you want it
