...
puts "Reservations #1 has user name #{Reservation.first.user.name} (should be 'Test User 1')"
puts "Reservations #2 has flight number #{Reservation.second.flight.flight_number} (should be 'BA256')"
puts
puts "Done."